...
*
* The method should return the string "Invalid value" in the method if either of the above are not true.
*
...
*
* Validate that it is >= 0, and return the string "Invalid value" if it is not true.
*
...
public class SecondsAndMinutesChallenge {
    ...
    // Constants:
    private static final String INVALID_VALUE_MESSAGE = "Invalid value"; // This will be explained later on the course.
